...
export const useFriendsStore = create<FriendsState>((set, get) => ({
  ...
  loadRanks: async () => {
    try {
      const res = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/ranks.json`);
  ...
  loginFriendsAccount: async (username, password) => {
    ...
    try {
      ...
      const res = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendsAccounts/${usernameLower}.json`);
      const data = await res.json();
  ...
  registerFriendsAccount: async (username, password) => {
    ...
    try {
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendsAccounts/${usernameLower}.json`, {
        method: 'PUT',
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${uuid}.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  logoutFriendsAccount: async () => {
    ...
    if (account) {
      try {
        await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${account.uuid}/state.json`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify('OFFLINE')
        });
        await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${account.uuid}/lastActive.json`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
  ...
  loadFriends: async (force = false) => {
    ...
    try {
      ...
      const friendsRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friends/${myUuid}.json`);
      ...
      if (friendsData) {
        ...
        const friendsDetails = await Promise.all(
          friendUuids.map(async (fUuid) => {
            try {
              const userRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${fUuid}.json`);
  ...
  loadPendingRequests: async () => {
    try {
      ...
      const reqsRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendRequests/${myUuid}.json`);
      ...
      if (reqsData) {
        ...
        requestsList = await Promise.all(keys.map(async (key) => {
          ...
          try {
            const senderRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${req.senderUuid}.json`);
            const senderData = await senderRes.json();
            const receiverRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${req.receiverUuid}.json`);
  ...
  loadCurrentUser: async () => {
    try {
      ...
      const res = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${myUuid}.json`);
      ...
      if (!userData) {
        ...
        await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${myUuid}.json`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(userData)
        });
  ...
  sendRequest: async (name: string) => {
    try {
      ...
      const res = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendsAccounts/${nameLower}.json`);
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendRequests/${targetUuid}/${myUuid}.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ ...requestObj, id: myUuid })
      });

      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendRequests/${myUuid}/${targetUuid}.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  acceptRequest: async (name: string) => {
    try {
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendRequests/${myUuid}/${friendUuid}.json`, { method: 'DELETE' });
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friendRequests/${friendUuid}/${myUuid}.json`, { method: 'DELETE' });

      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friends/${myUuid}/${friendUuid}.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ active: true, pingEnabled: false })
      });
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friends/${friendUuid}/${myUuid}.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ active: true, pingEnabled: false })
      });
  ...
  removeFriend: async (name: string, uuid: string) => {
    try {
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friends/${myUuid}/${uuid}.json`, { method: 'DELETE' });
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friends/${uuid}/${myUuid}.json`, { method: 'DELETE' });
  ...
  setStatus: async (status: OnlineState) => {
    try {
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${myUuid}/state.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  togglePing: async (friendName: string) => {
    try {
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/friends/${myUuid}/${friend.uuid}/pingEnabled.json`, {
        method: 'PUT',
    ...
    const syncLoop = async () => {
      try {
        ...
        if (activeFriend) {
          ...
          const msgRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/messages/${chatId}.json`);
          ...
          const typingRes = await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/chats/${chatId}/typing.json`);
  ...
  updatePrivacySetting: async (setting: string, value: boolean) => {
    try {
      ...
      await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${currentUser.uuid}/privacy/${setting}.json`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
      ...
      try {
        ...
        if (!currentAccount || currentAccount.uuid !== accountObj.uuid) {
          if (currentAccount) {
            await get().disconnectWebSocket();
            try {
              await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${currentAccount.uuid}/state.json`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify('OFFLINE')
              });
              await fetch(`https://primeclienttzt-default-rtdb.asia-southeast1.firebasedatabase.app/users/${currentAccount.uuid}/lastActive.json`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(0)
              });
